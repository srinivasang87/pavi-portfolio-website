...
const TimeTravel = () => {
  ...
  return (<div className="timetravel-super-container">
    ...
    <Row><Col className="timeTravelOuterImages" onClick={() => { setShow(true); setModalCarouselIndex(0); setCarouselLabel(imgs[0].leLabel); } }><a href="#"><img src={imgs[0].leBigImg} className="rounded mx-auto d-block makeItResponsive" alt="..." /></a></Col></Row>
    <Row><Col className="timeTravelOuterImages" onClick={() => { setShow(true); setModalCarouselIndex(1); setCarouselLabel(imgs[1].leLabel); } }><a href="#"><img src={imgs[1].leBigImg} className="rounded mx-auto d-block makeItResponsive" alt="..." /></a></Col></Row>
    <Row><Col className="timeTravelOuterImages" onClick={() => { setShow(true); setModalCarouselIndex(2); setCarouselLabel(imgs[2].leLabel); } }><a href="#"><img src={imgs[2].leBigImg} className="rounded mx-auto d-block makeItResponsive" alt="..." /></a></Col></Row>
    
    <Row><Col className="timeTravelOuterImages" onClick={() => { setShow(true); setModalCarouselIndex(3); setCarouselLabel(imgs[3].leLabel); } }><a href="#"><img src={imgs[3].leBigImg} className="rounded mx-auto d-block makeItResponsive" alt="..." /></a></Col></Row>
    <Row><Col className="timeTravelOuterImages" onClick={() => { setShow(true); setModalCarouselIndex(4); setCarouselLabel(imgs[4].leLabel); } }><a href="#"><img src={imgs[4].leBigImg} className="rounded mx-auto d-block makeItResponsive" alt="..." /></a></Col></Row>
    <Row><Col className="timeTravelOuterImages" onClick={() => { setShow(true); setModalCarouselIndex(5); setCarouselLabel(imgs[5].leLabel); } }><a href="#"><img src={imgs[5].leBigImg} className="rounded mx-auto d-block makeItResponsive" alt="..." /></a></Col></Row>
      
    <Row><Col className="timeTravelOuterImages" onClick={() => { setShow(true); setModalCarouselIndex(6); setCarouselLabel(imgs[6].leLabel); } }><a href="#"><img src={imgs[6].leBigImg} className="rounded mx-auto d-block makeItResponsive" alt="..." /></a></Col></Row>
    <Row><Col className="timeTravelOuterImages" onClick={() => { setShow(true); setModalCarouselIndex(7); setCarouselLabel(imgs[7].leLabel); } }><a href="#"><img src={imgs[7].leBigImg} className="rounded mx-auto d-block makeItResponsive" alt="..." /></a></Col></Row>
    <Row><Col className="timeTravelOuterImages" onClick={() => { setShow(true); setModalCarouselIndex(8); setCarouselLabel(imgs[8].leLabel); } }><a href="#"><img src={imgs[8].leBigImg} className="rounded mx-auto d-block makeItResponsive" alt="..." /></a></Col></Row>
    
    <Row><Col className="timeTravelOuterImages" onClick={() => { setShow(true); setModalCarouselIndex(9); setCarouselLabel(imgs[9].leLabel); } }><a href="#"><img src={imgs[9].leBigImg} className="rounded mx-auto d-block makeItResponsive" alt="..." /></a></Col></Row>
    <Row><Col className="timeTravelOuterImages" onClick={() => { setShow(true); setModalCarouselIndex(10); setCarouselLabel(imgs[10].leLabel); } }><a href="#"><img src={imgs[10].leBigImg} className="rounded mx-auto d-block makeItResponsive" alt="..." /></a></Col></Row>
    <Row><Col className="timeTravelOuterImages" onClick={() => { setShow(true); setModalCarouselIndex(11); setCarouselLabel(imgs[11].leLabel); } }><a href="#"><img src={imgs[11].leBigImg} className="rounded mx-auto d-block makeItResponsive" alt="..." /></a></Col></Row>
    
    <Row><Col className="timeTravelOuterImages" onClick={() => { setShow(true); setModalCarouselIndex(12); setCarouselLabel(imgs[12].leLabel); } }><a href="#"><img src={imgs[12].leBigImg} className="rounded mx-auto d-block makeItResponsive" alt="..." /></a></Col></Row>
    <Row><Col className="timeTravelOuterImages" onClick={() => { setShow(true); setModalCarouselIndex(13); setCarouselLabel(imgs[13].leLabel); } }><a href="#"><img src={imgs[13].leBigImg} className="rounded mx-auto d-block makeItResponsive" alt="..." /></a></Col></Row>
    <Row><Col className="timeTravelOuterImages" onClick={() => { setShow(true); setModalCarouselIndex(14); setCarouselLabel(imgs[14].leLabel); } }><a href="#"><img src={imgs[14].leBigImg} className="rounded mx-auto d-block makeItResponsive" alt="..." /></a></Col></Row>
    
    <Row><Col className="timeTravelOuterImages" onClick={() => { setShow(true); setModalCarouselIndex(15); setCarouselLabel(imgs[15].leLabel); } }><a href="#"><img src={imgs[15].leBigImg} className="rounded mx-auto d-block makeItResponsive" alt="..." /></a></Col></Row>
    <Row><Col className="timeTravelOuterImages" onClick={() => { setShow(true); setModalCarouselIndex(16); setCarouselLabel(imgs[16].leLabel); } }><a href="#"><img src={imgs[16].leBigImg} className="rounded mx-auto d-block makeItResponsive" alt="..." /></a></Col></Row>
    <Row><Col className="timeTravelOuterImages" onClick={() => { setShow(true); setModalCarouselIndex(17); setCarouselLabel(imgs[17].leLabel); } }><a href="#"><img src={imgs[17].leBigImg} className="rounded mx-auto d-block makeItResponsive" alt="..." /></a></Col></Row>
    
    <Row><Col className="timeTravelOuterImages" onClick={() => { setShow(true); setModalCarouselIndex(18); setCarouselLabel(imgs[18].leLabel); } }><a href="#"><img src={imgs[18].leBigImg} className="rounded mx-auto d-block makeItResponsive" alt="..." /></a></Col></Row>
    <Row><Col className="timeTravelOuterImages" onClick={() => { setShow(true); setModalCarouselIndex(19); setCarouselLabel(imgs[19].leLabel); } }><a href="#"><img src={imgs[19].leBigImg} className="rounded mx-auto d-block makeItResponsive" alt="..." /></a></Col></Row>
    <Row><Col className="timeTravelOuterImages" onClick={() => { setShow(true); setModalCarouselIndex(20); setCarouselLabel(imgs[20].leLabel); } }><a href="#"><img src={imgs[20].leBigImg} className="rounded mx-auto d-block makeItResponsive" alt="..." /></a></Col></Row>
    
    <Row><Col className="timeTravelOuterImages" onClick={() => { setShow(true); setModalCarouselIndex(21); setCarouselLabel(imgs[21].leLabel); } }><a href="#"><img src={imgs[21].leBigImg} className="rounded mx-auto d-block makeItResponsive" alt="..." /></a></Col></Row>
    <Row><Col className="timeTravelOuterImages" onClick={() => { setShow(true); setModalCarouselIndex(22); setCarouselLabel(imgs[22].leLabel); } }><a href="#"><img src={imgs[22].leBigImg} className="rounded mx-auto d-block makeItResponsive" alt="..." /></a></Col></Row>
    <Row><Col className="timeTravelOuterImages" onClick={() => { setShow(true); setModalCarouselIndex(23); setCarouselLabel(imgs[23].leLabel); } }><a href="#"><img src={imgs[23].leBigImg} className="rounded mx-auto d-block makeItResponsive" alt="..." /></a></Col></Row>
    
    <Row><Col className="timeTravelOuterImages" onClick={() => { setShow(true); setModalCarouselIndex(24); setCarouselLabel(imgs[24].leLabel); } }><a href="#"><img src={imgs[24].leBigImg} className="rounded mx-auto d-block makeItResponsive" alt="..." /></a></Col></Row>
    <Row><Col className="timeTravelOuterImages" onClick={() => { setShow(true); setModalCarouselIndex(25); setCarouselLabel(imgs[25].leLabel); } }><a href="#"><img src={imgs[25].leBigImg} className="rounded mx-auto d-block makeItResponsive" alt="..." /></a></Col></Row>
    <Row><Col className="timeTravelOuterImages" onClick={() => { setShow(true); setModalCarouselIndex(26); setCarouselLabel(imgs[26].leLabel); } }><a href="#"><img src={imgs[26].leBigImg} className="rounded mx-auto d-block makeItResponsive" alt="..." /></a></Col></Row>
